  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-md bg-gradient-brand px-4 py-2 text-sm font-medium text-accent-foreground hover:opacity-90">
            Go home
          </Link>
        </div>
      </div>
...
{/* WhatsApp Floating Button */}
  ...
  href="https://wa.me/919880577140?text=Hi%2C%20I%27m%20interested%20in%20your%20packaging%20solutions."
  target="_blank"
...
>
  <svg viewBox="0 0 24 24" className="h-7 w-7 fill-white">
    ...
    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.122 1.532 5.852L.057 23.25a.75.75 0 0 0 .916.916l5.398-1.475A11.95 11.95 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.713 9.713 0 0 1-4.962-1.362l-.355-.212-3.683 1.004 1.004-3.683-.212-.355A9.712 9.712 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
  </svg>
</a>
      </div>
    </QueryClientProvider>
